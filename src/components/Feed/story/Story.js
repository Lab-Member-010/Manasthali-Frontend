...
//       {/* Profile Circle - Click to select file */}
//       <div className={styles.circle} onClick={handleProfileClick}>
//         <img
//           src={user?.profile_picture ? user.profile_picture : "./default_profile.jpg"}
//           alt="Profile"
//           className={loading ? styles.loading : styles.profileImage} // Apply loading effect
//         />
//       </div>
